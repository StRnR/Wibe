...
//                        startActivity(new Intent(SignUpActivity.this, ConfirmEmailActivity.class));
                        ...
                        try {
                            ...
                            StaticTools.LogErrorMessage(String.format("sign up catch: %s", e.getMessage()));
                        }
            ...
            public void onResponse(Call<AuthenticationResponseModel> call, Response<AuthenticationResponseModel> response) {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        SavedInfo info = new SavedInfo(name, token, email);
                        info.save();
                    ...
                    try {
                        ...
                        StaticTools.LogErrorMessage(String.format("sign up: %s", e.getMessage()));
                    }
                }
            }
